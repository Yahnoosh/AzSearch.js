                ...
                <li key={index + 1} className={css.searchFacets__facetControl}>
                    <div className={css.searchFacets__facetControlCheckboxWrapper}>
                        <label className="checkboxLabel">
                            <input type="checkbox" className={css.searchFacets__facetControlCheckbox} onChange={toggleFacet.bind(null, valueKey)} checked={value.selected} /> {value.value + " "}({value.count})
                                        </label>
                    </div>
                </li>
            );
